...
public class OrderService implements IOrderService {
    ...
    public void testTransactional() {
        ...
        orderMapper.insert("INSERT INTO tx_order_reviewed (sharding_key,order_id, reviewed_status, reviewed_star, reviewed_content, remark, create_date) VALUES ('1-1', 1062429, 1, 5, '导购很专业,用材绿色环保,售后放心,导购非常热情,设计新颖,促销很优惠', '5b6I5qOS77yB54m55Yir5Zac5qyi77yB5YC85b6X6LSt5Lmw', '2018-04-03 20:15:02');");

        int rs = orderMapper.insert(test);
