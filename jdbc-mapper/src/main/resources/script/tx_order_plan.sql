...
CREATE TABLE `tx_attachment` (
  ...
  CONSTRAINT `fk_attachment_to_custom_service` FOREIGN KEY (`customer_service_id`) REFERENCES `tx_customer_service` (`id`),
  CONSTRAINT `fk_attachment_to_return_info` FOREIGN KEY (`return_info_id`) REFERENCES `tx_return_info` (`id`)
...
CREATE TABLE `tx_order` (
  ...
  CONSTRAINT `fk_order_to_order` FOREIGN KEY (`reference_id`) REFERENCES `tx_order` (`id`)
...
) ENGINE=InnoDB 45842 DEFAULT CHARSET=utf8;
