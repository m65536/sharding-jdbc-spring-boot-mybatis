use tx_order_master_0;

/*
Navicat MySQL Data Transfer

Source Server         : prd_order
Source Server Version : 50626
Source Host           : 172.18.66.18:3306
Source Database       : tx_order

Target Server Type    : MYSQL
Target Server Version : 50626
File Encoding         : 65001

Date: 2018-05-01 11:37:31
*/
...
) ENGINE=InnoDB AUTO_INCREMENT=15735 DEFAULT CHARSET=utf8 COMMENT='售后服务表';
...
CREATE TABLE `tx_item_payment` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=748392 DEFAULT CHARSET=utf8 COMMENT='商品费用明细表';
...
) ENGINE=InnoDB AUTO_INCREMENT=1687469 DEFAULT CHARSET=utf8;
...
CREATE TABLE `tx_operation_history` (
  ...
  `create_date` datetime NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=772786 DEFAULT CHARSET=utf8 COMMENT='订单操作记录';
...
) ENGINE=InnoDB AUTO_INCREMENT=1726910 DEFAULT CHARSET=utf8 COMMENT='订单主表';
...
-- ----------------------------
-- Table structure for tx_order_deliver_info
-- ----------------------------
DROP TABLE IF EXISTS `tx_order_deliver_info`;
CREATE TABLE `tx_order_deliver_info` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `order_id` bigint(20) DEFAULT NULL COMMENT '订单id',
  `order_item_id` bigint(20) DEFAULT NULL COMMENT '商品id',
  `deliver_status` int(11) DEFAULT NULL COMMENT '商品物流状态',
  `deliver_type` int(11) DEFAULT NULL COMMENT '物流类型',
  `deliver_date` datetime DEFAULT NULL COMMENT '送货日期',
  `install_date` datetime DEFAULT NULL COMMENT '安装日期',
  `real_deliver_date` datetime DEFAULT NULL COMMENT '实际送货日期 ',
  `real_install_date` datetime DEFAULT NULL COMMENT '实际安装日期',
  `received_date` datetime DEFAULT NULL COMMENT '收货日期',
  `real_received_date` datetime DEFAULT NULL COMMENT '实际收货日期',
  PRIMARY KEY (`id`),
  KEY `fk_order_deliver_info_to_order_idx` (`order_id`) USING BTREE,
  KEY `fk_order_deliver_info_to_order_item_idx` (`order_item_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=59761 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Table structure for tx_order_distribute
-- ----------------------------
DROP TABLE IF EXISTS `tx_order_distribute`;
CREATE TABLE `tx_order_distribute` (
  ...
  `dealer_id` varchar(255) DEFAULT NULL COMMENT '经销商id',
  `dealer_name` varchar(100) DEFAULT NULL COMMENT '商户名称',
  `market_id` varchar(255) DEFAULT NULL COMMENT '商场id',
  `market_name` varchar(255) DEFAULT NULL COMMENT '商场名称',
  `dist_status` tinyint(1) DEFAULT '1' COMMENT '1 已分单 2 已接单  4 失效',
  `dist_time` datetime DEFAULT NULL COMMENT '分单时间',
  `dist_user_id` varchar(255) DEFAULT NULL COMMENT '分单人id',
  `dist_user_name` varchar(255) DEFAULT NULL COMMENT '分单人姓名',
  `accept_time` datetime DEFAULT NULL COMMENT '接单时间',
  `accept_user_id` varchar(255) DEFAULT NULL COMMENT '接单人id',
  `accept_user_name` varchar(255) DEFAULT NULL COMMENT '接单人姓名',
  `mobile` varchar(20) DEFAULT NULL COMMENT '经销商移动电话',
  PRIMARY KEY (`id`),
  KEY `idx_order_id` (`order_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='分单表';
...
CREATE TABLE `tx_order_item` (
  ...
  KEY `idx_sku` (`sku`)
) ENGINE=InnoDB AUTO_INCREMENT=3025217 DEFAULT CHARSET=utf8;
...
CREATE TABLE `tx_order_reviewed` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_order_id` (`order_id`)
) ENGINE=InnoDB AUTO_INCREMENT=12969 DEFAULT CHARSET=utf8 COMMENT='订单匿名评价';
...
-- ----------------------------
-- Table structure for tx_parking_fees
-- ----------------------------
DROP TABLE IF EXISTS `tx_parking_fees`;
CREATE TABLE `tx_parking_fees` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键，非自增，随tx_order表id，步长＝1',
  `user_member_id` bigint(20) DEFAULT NULL COMMENT '对应用户中心用户id',
  `parking_order_no` varchar(30) DEFAULT NULL COMMENT '对应用户中心生成的停车单号',
  `third_order_no` varchar(50) DEFAULT NULL COMMENT '对应供应商订单号',
  `car_no` varchar(12) DEFAULT NULL COMMENT '车牌号',
  `create_date` datetime DEFAULT NULL COMMENT '创建时间',
  `start_time` datetime DEFAULT NULL COMMENT '入场时间',
  `end_time` datetime DEFAULT NULL COMMENT '出场时间',
  `service_time` int(20) DEFAULT NULL COMMENT '停车时长（秒）',
  `service_time_str` varchar(20) DEFAULT NULL COMMENT '停车时长（时-分-秒）',
  `reduce_score` int(11) DEFAULT NULL COMMENT '抵扣积分',
  `freeze_score` int(11) DEFAULT NULL COMMENT '冻结积分',
  `is_used_ticket` tinyint(1) DEFAULT NULL COMMENT '是否使用停车券（1：使用， 0：不使用）',
  `ticket_id` int(20) DEFAULT NULL COMMENT '停车券id',
  `rights_id` varchar(20) DEFAULT NULL COMMENT '权益id',
  `rights_name` varchar(30) DEFAULT NULL COMMENT '权益名称',
  `is_used_rights` tinyint(1) DEFAULT NULL COMMENT '是否使用权益（1：使用，0：不使用）',
  `park_code` varchar(20) DEFAULT NULL COMMENT '停车场编码',
  `park_name` varchar(20) DEFAULT NULL COMMENT '停车场名称',
  PRIMARY KEY (`id`),
  KEY `idx_parking_order_no` (`parking_order_no`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='停车费';
...
) ENGINE=InnoDB AUTO_INCREMENT=1789107 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=1253912 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Table structure for tx_pay_error_log
-- ----------------------------
DROP TABLE IF EXISTS `tx_pay_error_log`;
CREATE TABLE `tx_pay_error_log` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `create_date` datetime DEFAULT NULL,
  `host_info` varchar(64) DEFAULT NULL,
  `remark` varchar(500) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=32494 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=495414 DEFAULT CHARSET=utf8;
...
CREATE TABLE `tx_promotion_job` (
  ...
  `create_date` datetime NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3362 DEFAULT CHARSET=utf8 COMMENT='外部job数据处理表';

-- ----------------------------
-- Table structure for tx_rabbitmq_push_log
-- ----------------------------
DROP TABLE IF EXISTS `tx_rabbitmq_push_log`;
CREATE TABLE `tx_rabbitmq_push_log` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `order_id` bigint(20) NOT NULL COMMENT '对应订单id',
  `type` varchar(10) NOT NULL COMMENT '推送日志类型',
  `serial_number` varchar(255) NOT NULL COMMENT '订单序列号',
  `push_msg` text COMMENT '推送详情',
  `create_date` datetime NOT NULL COMMENT '推送时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=30986 DEFAULT CHARSET=utf8 COMMENT='rabbitmq推送日志';
...
CREATE TABLE `tx_refund_bill` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_order_id` (`order_id`)
) ENGINE=InnoDB AUTO_INCREMENT=190 DEFAULT CHARSET=utf8 COMMENT='退款费用明细';
...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='退货详情表';
...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='退货信息表';

-- ----------------------------
-- Table structure for tx_serial_number
-- ----------------------------
